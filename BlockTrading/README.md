...
1. Call Get User Quote API to get a quote
Send the following fields to retrieve a quote:
  - Country
  - Token
  - Fiat
2. Use ADD Order API to place an off ramp order
...
| USDC   | ERC20,BEP20,POLYGON,SETLLAR        |
